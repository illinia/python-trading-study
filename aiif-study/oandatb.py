...
class OandaTradingBot(tpqoa.tpqoa):
    ...
    def on_success(self, time, bid, ask):
        ...
        if len(self.data) > self.min_length:
            ...
            prediction = np.argmax(self.agent.model.predict(state, verbose=0)[0, 0])
...
if __name__ == '__main__':
    ...
    # model = keras.models.load_model('./tradingbot_model')
    # agent.model = model
    otb = OandaTradingBot('./aiif.cfg', agent, '5s', 25000, verbose=False)
